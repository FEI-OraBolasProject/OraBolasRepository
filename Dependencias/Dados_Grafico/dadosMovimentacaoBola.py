...
def dadosVelBola(tempoFinal,robo):

    if(robo['querAlterarRaio'] == 0):
        # Leitura de dados do arquivo trajetoria_bola.txt
        traj_bola = open("Dependencias/trajetoria_formatada.txt", "r")  #
        ...
        velocidade_bola = open("Dependencias/Dados_Grafico/Gerar_Grafico/velocidade_bola.txt", "w")
        ...
        velocidade_bola = open("Dependencias/Dados_Grafico/Gerar_Grafico/RA_velocidade_bola.txt", "w")
...
def dadosAcelBola(robo):
    ...
    if (robo['querAlterarRaio'] == 0):
        ...
        aceleracao_bola = open("Dependencias/Dados_Grafico/Gerar_Grafico/acel_bola.txt", "w")
        ...
        aceleracao_bola = open("Dependencias/Dados_Grafico/Gerar_Grafico/RA_acel_bola.txt", "w")
