from Dependencias.Interceptacao_Bola.interceptacao_bola import interceptacao_bola
from Dependencias.Dados_Grafico.dadosMovimentacaoBola import dadosVelBola,dadosAcelBola
from Dependencias.Dados_Grafico.criar_graficos import criar_graficos
from Dependencias.Dados_Grafico.velocidadeRelativa import pegarVelRelativa
