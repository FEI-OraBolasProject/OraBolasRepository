...
def aceleracao_robo(robo,path=os.getcwd()):
    ...
    if (robo['querAlterarRaio'] == 0):
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Padrao/acel_robo.png", dpi=300, bbox_inches='tight')
        plt.close()
    
    else:
        dataset = open(path + "/Dados_Grafico/Gerar_Grafico/RA_acel_robo.txt", "r")
        linhas = dataset.readlines()
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Alterado/RA_acel_robo.png", dpi=300, bbox_inches='tight')
        plt.close()
...
def aceleracao_bola(robo,path=os.getcwd()):
    if (robo['querAlterarRaio'] == 0):
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Padrao/acel_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
    
    else:  
        # separar em listas as linhas do excel
        dataset = open(path + "/Dados_Grafico/Gerar_Grafico/RA_acel_bola.txt", "r")
        linhas = dataset.readlines()
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Alterado/RA_acel_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
...
def distancia_relativa(robo,path=os.getcwd()):
    if (robo['querAlterarRaio'] == 0):
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Padrao/distancia_robo_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
        
    else:
        # separar em listas as linhas do excel
        dataset = open(path + "/Dados_Grafico/Gerar_Grafico/RA_distancia_robo_bola.txt", "r")
        linhas = dataset.readlines()
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Alterado/RA_distancia_robo_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
...
def velocidade_bola(robo,path = os.getcwd()):
    if (robo['querAlterarRaio'] == 0):
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Padrao/velocidade_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
        
    else:
        # separar em listas as linhas do excel
        dataset = open(path + "/Dados_Grafico/Gerar_Grafico/RA_velocidade_bola.txt", "r")
        linhas = dataset.readlines()
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Alterado/RA_velocidade_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
...
def velocidade_robo(robo,path = os.getcwd()):
    ...
    if (robo['querAlterarRaio'] == 0):
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Padrao/velocidade_robo.png", dpi=300, bbox_inches='tight')
        plt.close()
        
    else:
        # separar em listas as linhas do excel
        dataset = open(path + "/Dados_Grafico/Gerar_Grafico/RA_velocidade_robo.txt", "r")
        linhas = dataset.readlines()
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Alterado/RA_velocidade_robo.png", dpi=300, bbox_inches='tight')
        plt.close()
...
def pos_x_robo_bola(robo,path=os.getcwd()):
    ...
    if (robo['querAlterarRaio'] == 0):
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Padrao/x_t_robo_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
        
    else:
        # separar em listas as linhas do excel
        dataset = open(path + "/Dados_Grafico/Gerar_Grafico/RA_x_y_robo_bola.txt", "r")
        linhas = dataset.readlines()
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Alterado/RA_x_t_robo_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
...
def pos_xy_robo_bola(robo,path=os.getcwd()):
    ...
    if (robo['querAlterarRaio'] == 0):
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Padrao/x_y_robo_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Alterado/RA_x_y_robo_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
...
def pos_y_robo_bola(robo,path = os.getcwd()):
    ...
    if (robo['querAlterarRaio'] == 0):
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Padrao/y_t_robo_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Alterado/RA_y_t_robo_bola.png", dpi=300, bbox_inches='tight')
        plt.close()
...
def criarGraficoVelocidadeRelativa(robo,path = os.getcwd()):
    ...
    if (robo['querAlterarRaio'] == 0):
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Padrao/velocidade_relativa.png", dpi=300, bbox_inches='tight')
        plt.close()
        
    else:
        # separar em listas as linhas do excel
        dataset = open(path + "/Dados_Grafico/Gerar_Grafico/RA_velocidade_relativa.txt", "r")
        linhas = dataset.readlines()
        ...
        plt.savefig(path + "/Dados_Grafico/Gerar_Grafico/Graficos_Raio_Alterado/RA_velocidade_relativa.png", dpi=300, bbox_inches='tight')
        plt.close()
